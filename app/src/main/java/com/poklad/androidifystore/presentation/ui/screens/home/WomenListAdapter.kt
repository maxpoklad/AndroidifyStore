...
import com.poklad.androidifystore.databinding.ItemProductHorizonatalBinding
...
class WomenListAdapter : BaseAdapter<ProductItem>() {
    ...
    override fun getViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val binding =
            ItemProductHorizonatalBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return ProductsHolder(binding)
    }

    inner class ProductsHolder(private val binding: ItemProductHorizonatalBinding) :
